...
oblique <- function(P, N, x1rng = x1rng, x2rng = x2rng, seed = 2017) {
  ...
  with(df, {
    plot(x1,x2, col = (y + col.shift), pch = (y + pch.shift), cex.lab = cex.lab, cex.axis = cex.axis, cex = cex, cex.main = cex.main, xlim = x1rng, ylim = x2rng, main = "Oblique", xlab = expression('x'[1]), ylab = expression('x'[2]))
  })
  abline(0, 1, lty = 2)
  return(df)
}
...
circular <- function(P, N, x1rng = x1rng, x2rng = x2rng, seed = 2017) {
  ...
  with(df, {
    plot(x1,x2, col = (y + col.shift), pch = (y + pch.shift), cex.lab = cex.lab, cex.axis = cex.axis, cex = cex, cex.main = cex.main, xlim = x1rng, ylim = x2rng, main = "Circular", xlab = expression('x'[1]), ylab = expression('x'[2]))
  })
...
shape88 <- function(P, N, x1rng = x1rng, x2rng = x2rng, seed = 2017) {
  ...
  with(df, {
    plot(x1,x2, col = (y + col.shift), pch = (y + pch.shift), cex.lab = cex.lab, cex.axis = cex.axis, cex = cex, cex.main = cex.main, xlim = x1rng, ylim = x2rng, main = "Shape88", xlab = expression('x'[1]), ylab = expression('x'[2]))
  })
...
ringshape <- function(P, N, x1rng = x1rng, x2rng = x2rng, seed = 2017) {
  ...
  with(df, {
    plot(x1,x2, col = (y + col.shift), pch = (y + pch.shift), cex.lab = cex.lab, cex.axis = cex.axis, cex = cex, cex.main = cex.main, xlim = x1rng, ylim = x2rng, main = "Ring", xlab = expression('x'[1]), ylab = expression('x'[2]))
  })
...
diamond <- function(P, N, x1rng = x1rng, x2rng = x2rng, seed = 2017) {
  ...
  with(df, {
    plot(x1,x2, col = (y + col.shift), pch = (y + pch.shift), cex.lab = cex.lab, cex.axis = cex.axis, cex = cex, cex.main = cex.main, xlim = x1rng, ylim = x2rng, main = "Diamond", xlab = expression('x'[1]), ylab = expression('x'[2]))
  })
  abline(hw, 1, lty = 2)
  abline(hw, -1, lty = 2)
  abline(-hw, 1, lty = 2)
...
grid2x2 <- function(P, N, x1rng = x1rng, x2rng = x2rng, seed = 2017) {
  ...
  with(df, {
    plot(x1,x2, col = (y + col.shift), pch = (y + pch.shift), cex.lab = cex.lab, cex.axis = cex.axis, cex = cex, cex.main = cex.main, xlim = x1rng, ylim = x2rng, main = "Grid2x2", xlab = expression('x'[1]), ylab = expression('x'[2]))
  })
